    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-16 bg-background">
      <form onSubmit={onSubmit} className="w-full max-w-sm space-y-6">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-foreground text-background py-3 text-[12px] font-mono uppercase tracking-widest rounded hover:opacity-85 transition-opacity disabled:opacity-60"
        >
          {t("submit")}
        </button>
        <p className="text-xs text-muted-foreground text-center">
          {t("have_account")}{" "}
          <Link to="/login" className="text-accent border-b border-accent/30">
            {t("sign_in")}
          </Link>
        </p>
      </form>
